package com.ecommerce.api.restaurants.web.security;


import com.ecommerce.api.restaurants.domain.service.UserDetailService;
import com.ecommerce.api.restaurants.web.security.filter.JwtFilterRequest;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers("/**/commerces/**").permitAll()
